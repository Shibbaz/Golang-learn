...
var file_grpc_apikiller_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x99, 0x01, 0x0a, 0x03, 0x41,
...
var file_grpc_apikiller_proto_depIdxs = []int32{
	...
	2, // 3: grpc.API.getAllUsers:output_type -> grpc.APIReply
	2, // 4: grpc.API.getUserById:output_type -> grpc.APIReply
	2, // 5: grpc.API.createUser:output_type -> grpc.APIReply
