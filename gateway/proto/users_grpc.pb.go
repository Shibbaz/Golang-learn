...
func (c *usersClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
...
func (UnimplementedUsersServer) SayHello(context.Context, *HelloRequest) (*HelloReply, error) {
